...
public class GoodsRemoteConfig {
	...
	private static final String GOODS_CONFIG_FILE = "goods.rmi.properties";
	...
	private GoodsRemoteConfig() {
		try {
			...
			prop.load(Thread.currentThread().getContextClassLoader().getResourceAsStream(GOODS_CONFIG_FILE));
