 ...
 *
 */
public class GoodsRmiConfig {

	private static Logger logger = Logger.getLogger(GoodsRmiConfig.class);

	private static final GoodsRmiConfig instance = new GoodsRmiConfig();
	...
	public static final GoodsRmiConfig getInstance() {
		return instance;
	}
